...
{
	eventManager.subscribe<entityx::ComponentAddedEvent<PlayerComponent>>(*this);
}
...
void PlayerSystem::receive(const entityx::ComponentAddedEvent<PlayerComponent>& event)
{
	player = event.entity;
}
